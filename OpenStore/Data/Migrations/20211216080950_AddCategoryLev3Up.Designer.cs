...
namespace OpenStore.Data.Migrations
{
    ...
    [Migration("20211216080950_AddCategoryLev3Up")]
    partial class AddCategoryLev3Up
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OpenStore.Models.Product", b =>
                {
                    b.HasOne("OpenStore.Models.CategoryLev3", "CategoryLev3")
                        .WithMany("Products")
                        .HasForeignKey("CategoryLev3ID");
            ...
            modelBuilder.Entity("OpenStore.Models.PropertyLev1", b =>
                {
                    ...
                    b.HasOne("OpenStore.Models.CategoryLev3", null)
                        .WithMany("PropertyLev1s")
                        .HasForeignKey("CategoryLev3ID");
                });
